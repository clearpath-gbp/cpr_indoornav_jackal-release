## cpr_indoornav_jackal (noetic) - 0.4.3-1

The packages in the `cpr_indoornav_jackal` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_indoornav_jackal` on `Fri, 07 Jun 2024 17:14:10 -0000`
...
## cpr_indoornav_jackal (noetic) - 0.4.2-1

The packages in the `cpr_indoornav_jackal` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_indoornav_jackal` on `Mon, 27 May 2024 16:07:04 -0000`
...
## cpr_indoornav_jackal (noetic) - 0.4.1-1

The packages in the `cpr_indoornav_jackal` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_indoornav_jackal` on `Tue, 26 Mar 2024 15:46:57 -0000`
...
## cpr_indoornav_jackal (noetic) - 0.4.0-1
